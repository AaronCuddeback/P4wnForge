...
class PasswordCrackerApp:
    ...
    def setup_about_tab(self):
        ...
        logo_label = ttk.Label(logo_frame, text="PassCrack")
        logo_label.pack(anchor=tk.CENTER)
        
        try:
            # Try to load the logo image
            logo_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "hightech.png")
        ...
        ttk.Label(info_frame, text="PassCrack", font=("Helvetica", 16, "bold")).pack(anchor=tk.CENTER, pady=5)
